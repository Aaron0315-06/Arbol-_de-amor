...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Me gustas, no solo 'por que eres tan hermosa como el atadecer si no pro la paz que me generas al verte.. 💕.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con cariño , Aaron";
...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML =
      `Llevamos conociendonos : <b>${days}</b> días<br>` +
      `Nuestro primer encuentro: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
